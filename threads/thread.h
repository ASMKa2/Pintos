...
struct thread
  {
    ...
    struct semaphore sema_1;            /* synch for parent process waiting child process exit */
    ...
    struct hash vm;                     /* hash table for virtual memory */

    struct list mmap_list;              /* list for memory map */
    int mapid;                          /* count map id */
  };
...
/* List for page replacement */
struct list lru_list;

/* Lock for page replacement list */
struct lock lru_list_lock;

/* pointer for the victim page */
